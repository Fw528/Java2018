...
public class ReplayPainter implements Runnable {
	...
	final Image bro1 = new Image("1.png");
	final Image bro2 = new Image("2.png");
	final Image bro3 = new Image("3.png");
	final Image bro4 = new Image("4.png");
	final Image bro5 = new Image("5.png");
	final Image bro6 = new Image("6.png");
	final Image bro7 = new Image("7.png");
	final Image grandpa = new Image("yeye.png");
	final Image minion = new Image("Loulo.png");
	final Image scorpion = new Image("xiezi2.png");
	final Image snake = new Image("SHE.png");
	...
	final Image dead = new Image("gost.png");
